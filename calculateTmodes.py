...
#     sum_T_bend_norm = 0.0
#     count_T_bend_norm = 0
#     sum_T_bend_eq5_norm = 0.0  # For Equation 5 bend
#     count_T_bend_eq5_norm = 0  # For Equation 5 bend
#     sum_T_bend_exc = 0.0
#     count_T_bend_exc = 0
#     sum_T_bend_eq5_exc = 0.0  # For Equation 5 bend
#     count_T_bend_eq5_exc = 0  # For Equation 5 bend
#     sum_T_hb = 0.0
#     count_T_hb = 0
#     sum_T_twist = 0.0
#     count_T_twist = 0
...
def analyze_temps_numba(
    ...
    results_array = np.full((num_frames, 13), np.nan, dtype=np.float64)
    ...
    # Unpack results - updated with libration modes split into excited/normal
    ...
    # Update the calculation of means for all mode types
    ...
    print_overall_avg_T_bend_eq5_norm = robust_nanmean(frame_avg_T_bend_eq5_norm_list)
    ...
    # Update print statements with all mode types
    print(f"Overall Avg T_stretch_exc (Numba): {print_overall_avg_T_stretch_exc:.2f} K")
    print(
        f"Overall Avg T_stretch_norm (Numba): {print_overall_avg_T_stretch_norm:.2f} K"
    )
    print(f"Overall Avg T_bend_exc (Numba): {print_overall_avg_T_bend_exc:.2f} K")
    print(f"Overall Avg T_bend_norm (Numba): {print_overall_avg_T_bend_norm:.2f} K")
    print(
        f"Overall Avg T_bend_eq5_exc (Numba): {print_overall_avg_T_bend_eq5_exc:.2f} K"
    )
    print(
        f"Overall Avg T_bend_eq5_norm (Numba): {print_overall_avg_T_bend_eq5_norm:.2f} K"
    )
    print(f"Overall Avg T_hb (Numba): {print_overall_avg_T_hb:.2f} K")
    print(f"Overall Avg T_twist_exc (Numba): {print_overall_avg_T_twist_exc:.2f} K")
    print(f"Overall Avg T_twist_norm (Numba): {print_overall_avg_T_twist_norm:.2f} K")
    print(f"Overall Avg T_wag_exc (Numba): {print_overall_avg_T_wag_exc:.2f} K")
    print(f"Overall Avg T_wag_norm (Numba): {print_overall_avg_T_wag_norm:.2f} K")
    print(f"Overall Avg T_rock_exc (Numba): {print_overall_avg_T_rock_exc:.2f} K")
    print(f"Overall Avg T_rock_norm (Numba): {print_overall_avg_T_rock_norm:.2f} K")

    # Update returned dictionary with all mode types
    returned_data = {
